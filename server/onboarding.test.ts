...
const { importRosterProfiles, onboardingStatus, claimRosterProfile, approveRosterProfile, assignRosterProfile } = await import("./onboarding.js");
...
test("unique name + class match can be confirmed and opening money is journal-backed", async () => {
