...
export async function initSchema(): Promise<void> {
  ...
  const stmts = [
    ...
    `CREATE INDEX IF NOT EXISTS idx_sl_bill_drafts_class ON bill_drafts(class_id, status, created_at)`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_sl_roster_profiles_match ON roster_profiles(class_id, normalized_name, status)`,
    `CREATE UNIQUE INDEX IF NOT EXISTS idx_sl_roster_profiles_claimed_by ON roster_profiles(class_id, claimed_by) WHERE claimed_by IS NOT NULL`,
